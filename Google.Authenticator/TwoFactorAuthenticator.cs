...
namespace Google.Authenticator
{
    ...
    public class TwoFactorAuthenticator
    {
        ...
        /// <summary>
        /// 生成用户可扫描的谷歌认证初始码 Generate a setup code for a Google Authenticator user to scan.
        /// </summary>
        ...
        /// <summary>
        /// 生成用户可扫描的谷歌认证初始码（附带发行者ID） Generate a setup code for a Google Authenticator user to scan (with issuer ID).
        /// </summary>
